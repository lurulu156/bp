...
//authenticate for all controller
...
app.UseCsp(opt => opt
    ...
    .ScriptSources(s => s.Self().UnsafeInline().CustomSources("https://cdnjs.cloudflare.com", "https://cdn.jsdelivr.net"))
);
...
//setting up for db auto mirgration
